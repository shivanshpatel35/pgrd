...
from train.droid.camera_utils.info import camera_type_to_string_dict
from train.droid.camera_utils.wrappers.recorded_multi_camera_wrapper import (
    RecordedMultiCameraWrapper,
)
from train.droid.trajectory_utils.trajectory_reader import TrajectoryReader
from train.droid.trajectory_utils.trajectory_writer import TrajectoryWriter
...
def collect_trajectory(
    ...
    if save_filepath:
        traj_writer = TrajectoryWriter(
            save_filepath, metadata=metadata, save_images=save_images
        )
